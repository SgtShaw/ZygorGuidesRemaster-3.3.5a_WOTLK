-- Optional profile (off by default).
-- Source: original, unmodified Alliance leveling guide content from classic Zygor guide sources.
-- Use this profile only if you have issues following the recommended TrinityCore-oriented leveling guide.
-- Enable by switching the Alliance leveling script line in Guides\Autoload.xml.
