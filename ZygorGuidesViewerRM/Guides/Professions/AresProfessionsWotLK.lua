...
ZygorGuidesViewer:RegisterGuide("Ares' WotLK 3.3.5a Guides\\Professions\\Mining 1-450 (WotLK Route)",[[
	...
	step
		loop Dun Morogh,28.6,42.5;30.8,34.6;35.6,27.7;43.8,24.8;50.3,28.4;52.6,37.7;48.4,46.4;40.7,49.9;33.1,47.2 |until skill("Mining")>=65
		#include "follow_path_mine"
		skill Mining,65
	step
		loop Elwynn Forest,42.4,66.2;37.5,61.0;32.8,57.0;27.9,53.8;25.8,46.2;31.4,39.2;39.6,38.6;47.2,43.4;50.8,52.8;49.5,62.4 |until skill("Mining")>=65
		#include "follow_path_mine"
		skill Mining,65
	step
		#include "trainer_Mining"
